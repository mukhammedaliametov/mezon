...
import BBQHeroImg from "../assets/bbq_hero.jpg";
    ...
    >
      ...
      <div className="flex flex-col justify-end z-20 w-[620px] text-white">
        ...
        <p className="text-[18px]/[24px] md:text-[22px]/[28px] font-[300] mt-[20px]">
          На ЦАО "Евразия" вы всегда сможете отдохнуть большой компанией в
          аренах BBQ . Что может быть лучше сочетания активного отдыха в
          отличной компании и BBQ собствественного приготовления?
        </p>
      </div>
