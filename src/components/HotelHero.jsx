...
const HotelHero = () => {
  ...
  return (
    <div
      style={{ backgroundImage: `url(${HotelHeroImg})` }}
    ...
    >
      ...
      <div className="flex flex-col justify-end z-20 w-[620px] text-white">
        ...
        <p className="text-[18px]/[24px] md:text-[22px]/[28px] font-[300] mt-[20px]">
          Найдите и забронируйте подходящий для Вас отель на официальном сайте
          Евразии. Широкий выбор отелей по всему курорту и самые низкие цены
          гарантированы
        </p>
      </div>
